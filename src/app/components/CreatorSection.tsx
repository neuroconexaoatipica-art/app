    ...
    <section className="w-full py-16 md:py-24 lg:py-28 bg-black">
      <div className="mx-auto max-w-[1100px] px-6 lg:px-8">
        <motion.h2
          ...
          className="text-3xl md:text-4xl lg:text-5xl mb-16 text-center font-semibold text-white"
        >
        ...
        <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 items-start">
          ...
          >
            <div className="relative group">
              <motion.div
                ...
                className="aspect-square rounded-3xl overflow-hidden shadow-xl ring-4 ring-[#81D8D0]/20"
              >
                {imgError ? (
          ...
          <div className="w-full lg:w-7/12 space-y-6">
            ...
            <motion.div
              ...
              className="space-y-6 text-lg md:text-xl leading-relaxed text-white"
            >
              <motion.p
                variants={{
